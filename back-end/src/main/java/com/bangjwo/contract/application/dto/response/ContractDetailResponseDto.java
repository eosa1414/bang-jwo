...
public class ContractDetailResponseDto {
	...
	@Schema(description = "계약 유형", example = "신규 계약", allowableValues = {"NEW", "RENEW_BY_AGREEMENT", "EXTENSION"})
	private ContractType contractType;

	@Schema(description = "임대 유형", example = "보증금 있는 월세", allowableValues = {"MONTHLY_WITH_DEPOSIT", "PURE_MONTHLY"})
